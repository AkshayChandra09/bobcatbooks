<?php
	...
	if(!empty($_SESSION["loginerror"]>0)) {
...
<html>
	<head>
		...
		<link rel="stylesheet" href="custom-styles1.css">
...
<!--Header Section-->
		<section>	
			...
			<form action="login_page.php" name="login_form" method="post">
			<table align="right" cellpadding="50" style="padding-top: 150px;padding-right: 50px; background-color:#A93226;">
			<div style="background-color:Maroon;">
				<tr>
					<td><input type="text" name="b_user_id" id="user_id" value="" placeholder="User ID" required></td>
  					<td> &nbsp &nbsp</td>
  					<td><input type="password" name="password" id="password" value="" placeholder="Password" required></td>
  					<td> &nbsp &nbsp</td>
  					<td><input type="submit" name="loginbtn" value="Log In" style="color: black; size:20"></td>
				</tr>
				<tr>
					<td colspan="3" align="right"><a href="forgotpassword.php"/><u>Forgot Password?</u></td><br>
				</tr>		
			</div>
			</table>
			</form>
	...
	if(bb_user_id == "" || password == "")
	 {
	 		...
	 		//document.getElementById('bb_user_id').style.borderColor = "blue";
        	return false;
	 }
